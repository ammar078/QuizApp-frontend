  ...
  return (
    examData && (
      <div className="mt-2"> 
        ...
        <h1 className="text-center mb-3">{ examData.name}</h1>
        ...
        {view === "result" && (
          <div className="flex  items-center mt-2 justify-center result">
            <div className="flex flex-col gap-2">
              <h1 className="text-2xl m-1">النتيجة</h1>
              <div className="marks">
                <h1 className="text-md ">الدرجة الاجمالية  : {examData.totalMarks}</h1>
                <h1 className="text-md">
                  الدرجة المحصلة :{result.correctAnswers.length}
                </h1>
                <h1 className="text-md">
                  الاجوبة الخاطئة : {result.wrongAnswers.length}
                </h1>
                <h1 className="text-md">
                  درجة النجاح  : {examData.passingMarks}
                </h1>
                <h1 className="text-md">النتيجة :{result.verdict}</h1>
